      ...
      <style>
        * {
        ...
        body {
          ...
          line-height: 1.6;
          color: #333;
          cursor: url('https://cdn.builder.io/api/v1/image/assets%2F2ac028268d0a425085f87821d101bd67%2F6dbf53c9e33342eea0da1ca70e76deba?format=webp&width=32') 16 16, auto;
          transition: transform 0.1s ease;
        }

        /* Click animation */
        body.clicking {
          cursor: url('https://cdn.builder.io/api/v1/image/assets%2F2ac028268d0a425085f87821d101bd67%2F6dbf53c9e33342eea0da1ca70e76deba?format=webp&width=40') 20 20, auto;
        }

        /* Special cursor for interactive elements */
        a, button, .learn-more-btn, .nav-links a {
          cursor: url('https://cdn.builder.io/api/v1/image/assets%2F2ac028268d0a425085f87821d101bd67%2F6dbf53c9e33342eea0da1ca70e76deba?format=webp&width=32') 16 16, pointer;
        }
