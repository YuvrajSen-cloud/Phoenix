      ...
      <style>
        * {
        ...
        body {
          ...
          line-height: 1.6;
          color: #333;
          cursor: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 24 32"><g transform="translate(12,16)"><rect x="-2" y="2" width="4" height="12" rx="2" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/><rect x="-1" y="-8" width="2" height="12" rx="1" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/><rect x="-6" y="4" width="3" height="8" rx="1.5" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/><rect x="3" y="4" width="3" height="8" rx="1.5" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/><rect x="-8" y="6" width="3" height="6" rx="1.5" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/><rect x="5" y="6" width="3" height="6" rx="1.5" fill="%23F4A261" stroke="%23E76F51" stroke-width="0.5"/></g></svg>') 12 16, auto;
          transition: transform 0.1s ease;
        }

        /* Click animation */
        body.clicking {
          cursor: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 24 32"><g transform="translate(12,16) scale(1.2)"><rect x="-2" y="2" width="4" height="12" rx="2" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/><rect x="-1" y="-8" width="2" height="12" rx="1" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/><rect x="-6" y="4" width="3" height="8" rx="1.5" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/><rect x="3" y="4" width="3" height="8" rx="1.5" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/><rect x="-8" y="6" width="3" height="6" rx="1.5" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/><rect x="5" y="6" width="3" height="6" rx="1.5" fill="%23E76F51" stroke="%23D62828" stroke-width="0.5"/></g></svg>') 12 16, auto;
        }

        /* Special cursor for interactive elements */
        a, button, .learn-more-btn, .nav-links a {
          cursor: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 24 32"><g transform="translate(12,16)"><rect x="-2" y="2" width="4" height="12" rx="2" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/><rect x="-1" y="-8" width="2" height="12" rx="1" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/><rect x="-6" y="4" width="3" height="8" rx="1.5" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/><rect x="3" y="4" width="3" height="8" rx="1.5" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/><rect x="-8" y="6" width="3" height="6" rx="1.5" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/><rect x="5" y="6" width="3" height="6" rx="1.5" fill="%232563eb" stroke="%231d4ed8" stroke-width="0.5"/></g></svg>') 12 16, pointer;
        }
